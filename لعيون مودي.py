...
g= datetime.datetime(2023, 11, 16, 0,  0, 0)
...
#		pwpluss.append('no')
	...
	cetak(panel(f'[bold white]عاوز تصيد باسورد من عندك? Y/T',width=79,title=f"[bold green]اعدادات يوزر اجينت",style="bold hot_pink2")) 
...
def passwrd():
	...
	print(f'\n\t\t\t{P}انتظر مودي هاد تحديث عشان تصيد وبس🥺{M}{P}')
